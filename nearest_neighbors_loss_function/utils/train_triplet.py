from nearest_neighbors_loss_function.utils.triplet_batch_shaper import TripletBatchShaper
...
def train_triplet(
    ...
    for id_seed, seed in enumerate(seeds):
        ...
        batch_shaper = TripletBatchShaper(device, training_type, batch_shaper_margin)
